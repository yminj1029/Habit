	...
	<header>
		...
		<div class="list" align="center">
			...
			<c:forEach var="vo" items="${list}">
				<table>
					<a href="javascript:view('viewcode');">${vo.h_name}</a>
					<tr id="viewcode" style="display: none;">
						<td>Start : ${vo.h_startdate }</br>
						 End : ${vo.h_enddate}</br>
						  Alarm :15:00
						</td>
						<td><form action="./myhabit.do" method="get">
								<input class="btn btn-warning" type="submit"
									onclick="newHabit(event)" value="습관체크" style="color: white;"></form></td>
					</tr>
				</table>
			</c:forEach>
						...
						<div class="modal-body">
							...
							<div class="form-row">
								...
								<div class="form-group col-sm-4">
									<label>습관 시작 연도</label> <select name="habitStartYear"
										class="form-control">
							...
							<div class="form-row">
								<div class="form-group col-sm-4">
									<label>습관 마감 연도</label> <select name="habitEndYear"
										class="form-control">
										<option value="선택" selected>선택</option>
										<option value="2020">2020</option>
										<option value="2021">2021</option>
							...
							<div class="form-row">
								<div class="form-group col-sm-6">
									<label>알람 요일</label> <input type="text" name="alarmDays"
										...
										placeholder="예) SUN/M/T/W/TH/F/SAT">
								</div>
								<div class="form-group col-sm-6">
									<form name=exf1>
										<B>알람설정 :</B> <input type=text name=h size=2>시 <input
											type=text name=m size=2> 분 <input type=text name=s
											size=2>초 <input type=button name=b onclick=setAlarm()
											value="Set Alarm"><input type=button name=r
											onclick=clearAlarm() value="Turn Alarm Off"><BR>
									</form>
								</div>
							</div>
							<div class="modal-footer">
								<input class="btn btn-primary" type="submit"
									onclick="newHabit(event)" value="등록완료" style="color: white;">
