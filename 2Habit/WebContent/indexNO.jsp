	...
	<div id="wrapper">
		...
		<header id="header">
			...
			<nav>
				<ul>
					<!-- 09.18 -->
					<li><a href="#intro">나의 습관</a></li>
					<li><a href="#work">함께해요!</a></li>
		...
		<div id="main">
			...
			<article id="intro">
				...
				<p>
					Aenean ornare velit lacus, ac varius enim ullamcorper eu.<a
						href="#work">awesome work</a>.
				</p>
			...
			<article id="work">
				...
				<input type="text" name="search_bar" id="search_bar" value=""
					placeholder="검색어를 입력하세요" /> <span class="image main"><img
					src="images/pic02.jpg" alt="" /></span>
				<p>Adipiscing magna sed dolor elit.</p>
				<p>Mauris aliquet magna magna sed nunc rhoncus pharetra.</p>
			</article>
			...
			<article id="about">
				...
				<p>Lorem ipsum dolor sit amet, consectetur et adipiscing elit.</p>
			</article>
