...
import habit.mem.pojo.Member2ContentController;
import habit.mem.pojo.Member2Controller;
import habit.mem.pojo.Member2DeleteController;
...
public class HandlerMapping {
	...
	private void initMap() {
		...
		mappings.put("/delete.do", new Member2DeleteController());
		mappings.put("/content.do", new Member2ContentController());
