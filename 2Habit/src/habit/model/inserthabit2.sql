...
INSERT INTO PROOF (PRF_ID,CH_ID,M_ID,PRF_DATE,CH_POINT,PRF_FILE) values (PROOF_SEQ.NEXTVAL, 1, 'hansung', '09/09/20', 1500, null);
INSERT INTO PROOF (PRF_ID,CH_ID,M_ID,PRF_DATE,CH_POINT,PRF_FILE) values (PROOF_SEQ.NEXTVAL, 2, 'minji', '09/10/20', 2000, null);
INSERT INTO PROOF (PRF_ID,CH_ID,M_ID,PRF_DATE,CH_POINT,PRF_FILE) values (PROOF_SEQ.NEXTVAL, 3, 'hyewon', '08/09/20', 1500, null);

INSERT INTO REVIEW (R_ID,CH_ID,M_ID,R_TITLE,R_CONTENT,R_DATE,R_POINT,R_FILE) values (REVIEW_SEQ.NEXTVAL,1, 'hansung', '하드캐리한썰푼다','미친듯이 집중햇다..ㅠ','09/09/20',500,  null);
INSERT INTO REVIEW (R_ID,CH_ID,M_ID,R_TITLE,R_CONTENT,R_DATE,R_POINT,R_FILE) values (REVIEW_SEQ.NEXTVAL,2, 'minji', '첫달성!!ㅜㅜ','와 진짜 처음으로 달성했다','09/10/20',500,  null);
INSERT INTO REVIEW (R_ID,CH_ID,M_ID,R_TITLE,R_CONTENT,R_DATE,R_POINT,R_FILE) values (REVIEW_SEQ.NEXTVAL,3, 'hyewon', '한번더달성!!!야호','아 진짜 달성했을때의 희열을 잊을수가없다..','08/09/20',500,  null);

INSERT INTO MY_RESULT (MR_ID, H_ID, M_ID, MR_DATE, MR_RESULT, MR_POINT) values (MY_RESULT_SEQ.NEXTVAL, 1, 'hansung', '20.08.01', '달성', 500);
INSERT INTO MY_RESULT (MR_ID, H_ID, M_ID, MR_DATE, MR_RESULT, MR_POINT) values (MY_RESULT_SEQ.NEXTVAL, 1, 'hansung', '20.08.03', '달성', 500);
INSERT INTO MY_RESULT (MR_ID, H_ID, M_ID, MR_DATE, MR_RESULT, MR_POINT) values (MY_RESULT_SEQ.NEXTVAL, 1, 'hansung', '20.08.05', '달성', 500);
INSERT INTO MY_RESULT (MR_ID, H_ID, M_ID, MR_DATE, MR_RESULT, MR_POINT) values (MY_RESULT_SEQ.NEXTVAL, 1, 'hansung', '20.08.07', '달성', 500);
INSERT INTO MY_RESULT (MR_ID, H_ID, M_ID, MR_DATE, MR_RESULT, MR_POINT) values (MY_RESULT_SEQ.NEXTVAL, 1, 'hansung', '20.08.09', '달성', 500);
INSERT INTO MY_RESULT (MR_ID, H_ID, M_ID, MR_DATE, MR_RESULT, MR_POINT) values (MY_RESULT_SEQ.NEXTVAL, 1, 'hansung', '20.08.11', '달성', 500);
INSERT INTO MY_RESULT (MR_ID, H_ID, M_ID, MR_DATE, MR_RESULT, MR_POINT) values (MY_RESULT_SEQ.NEXTVAL, 1, 'hansung', '20.08.13', '달성', 500);
INSERT INTO MY_RESULT (MR_ID, H_ID, M_ID, MR_DATE, MR_RESULT, MR_POINT) values (MY_RESULT_SEQ.NEXTVAL, 1, 'hansung', '20.08.15', '달성', 500);
INSERT INTO MY_RESULT (MR_ID, H_ID, M_ID, MR_DATE, MR_RESULT, MR_POINT) values (MY_RESULT_SEQ.NEXTVAL, 1, 'hansung', '20.08.17', '달성', 500);
INSERT INTO MY_RESULT (MR_ID, H_ID, M_ID, MR_DATE, MR_RESULT, MR_POINT) values (MY_RESULT_SEQ.NEXTVAL, 1, 'hansung', '20.08.19', '달성', 500);
INSERT INTO MY_RESULT (MR_ID, H_ID, M_ID, MR_DATE, MR_RESULT, MR_POINT) values (MY_RESULT_SEQ.NEXTVAL, 1, 'hansung', '20.08.21', '달성', 500);
...
INSERT INTO CHALLENGE_RESULT (CH_ID, CHM_ID, PRF_ID, CHR_DATE, CHR_RESULT) values (1, 1, 1, '09/09/20', '달성');
INSERT INTO CHALLENGE_RESULT (CH_ID, CHM_ID, PRF_ID, CHR_DATE, CHR_RESULT) values (2, 2, 2, '09/10/20', '달성');
INSERT INTO CHALLENGE_RESULT (CH_ID, CHM_ID, PRF_ID, CHR_DATE, CHR_RESULT) values (3, 3, 3, '08/09/20', '달성');
