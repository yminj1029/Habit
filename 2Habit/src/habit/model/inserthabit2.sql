...
INSERT INTO MY_HABIT (H_ID,M_ID,H_NAME,H_DAY,H_STARTDATE,H_ENDDATE,H_ALARM) values (MY_HABIT_SEQ.NEXTVAL ,'hansung','물마시기','MON','2020-08-07',null,'19:00:00');
INSERT INTO MY_HABIT (H_ID,M_ID,H_NAME,H_DAY,H_STARTDATE,H_ENDDATE,H_ALARM) values (MY_HABIT_SEQ.NEXTVAL,'hansung','핸드폰 시간 줄이기','TUES','2020-09-08',null,'19:00:00');
INSERT INTO MY_HABIT (H_ID,M_ID,H_NAME,H_DAY,H_STARTDATE,H_ENDDATE,H_ALARM) values (MY_HABIT_SEQ.NEXTVAL,'minji','일찍 일어나기','THUR','2020-07-08',null,'19:00:00');
INSERT INTO MY_HABIT (H_ID,M_ID,H_NAME,H_DAY,H_STARTDATE,H_ENDDATE,H_ALARM) values (MY_HABIT_SEQ.NEXTVAL,'hyewon','규칙적인 식사','WED','2020-09-06',null,'19:00:00');

INSERT INTO CHALLENGE (CH_ID,M_ID,CH_NAME,NUM,CH_DAY,STARTDATE,ENDDATE,CH_CONTENT,ALARM,CH_FILE) values (CHALLENGE_SEQ.NEXTVAL,'hansung','3달 10키로 감량',10,'MON, TUES, WED, THUR, FRI, SAT, SUN','2020-09-18','2020-12-18','- 하루 운동 최소 1시간! ','12:00:00',null);
INSERT INTO CHALLENGE (CH_ID,M_ID,CH_NAME,NUM,CH_DAY,STARTDATE,ENDDATE,CH_CONTENT,ALARM,CH_FILE) values (CHALLENGE_SEQ.NEXTVAL  ,'minji','핸드폰 사용시간 줄이기 프로젝트',10,'MON, TUES, WED, THUR, FRI, SAT, SUN','2020-03-01','2021-03-01','- 핸드폰 사용 금지 시간 설정 ','14:00:00',null);
INSERT INTO CHALLENGE (CH_ID,M_ID,CH_NAME,NUM,CH_DAY,STARTDATE,ENDDATE,CH_CONTENT,ALARM,CH_FILE) values (CHALLENGE_SEQ.NEXTVAL  ,'hyewon','5MIN ENGLISH TIME',10,'TUES, THUR, SAT, SUN', '2020-04-23','2020-10-23','- 하루 5분 영어 3줄 외우기 인증 (노트, 녹음, 만화 등등 모두 가능!)','12:00:00',null);
...
INSERT INTO MY_RESULT (MR_ID, H_ID, M_ID, MR_DATE, MR_RESULT, MR_POINT) values (MY_RESULT_SEQ.NEXTVAL, 1, 'hansung', '2020-09-02', '미달성', 500);
...
INSERT INTO MY_RESULT (MR_ID, H_ID, M_ID, MR_DATE, MR_RESULT, MR_POINT) values (MY_RESULT_SEQ.NEXTVAL, 1, 'hansung', '2020-09-04', '미달성', 500);
...
INSERT INTO MY_RESULT (MR_ID, H_ID, M_ID, MR_DATE, MR_RESULT, MR_POINT) values (MY_RESULT_SEQ.NEXTVAL, 1, 'hansung', '2020-09-06', '미달성', 500);
...
INSERT INTO MY_RESULT (MR_ID, H_ID, M_ID, MR_DATE, MR_RESULT, MR_POINT) values (MY_RESULT_SEQ.NEXTVAL, 1, 'hansung', '2020-09-08', '미달성', 500);
...
INSERT INTO MY_RESULT (MR_ID, H_ID, M_ID, MR_DATE, MR_RESULT, MR_POINT) values (MY_RESULT_SEQ.NEXTVAL, 1, 'hansung', '2020-09-10', '미달성', 500);
...
INSERT INTO MY_RESULT (MR_ID, H_ID, M_ID, MR_DATE, MR_RESULT, MR_POINT) values (MY_RESULT_SEQ.NEXTVAL, 1, 'hansung', '2020-09-12', '미달성', 500);
...
INSERT INTO MY_RESULT (MR_ID, H_ID, M_ID, MR_DATE, MR_RESULT, MR_POINT) values (MY_RESULT_SEQ.NEXTVAL, 1, 'hansung', '2020-09-14', '미달성', 500);
...
INSERT INTO MY_RESULT (MR_ID, H_ID, M_ID, MR_DATE, MR_RESULT, MR_POINT) values (MY_RESULT_SEQ.NEXTVAL, 1, 'hansung', '2020-09-16', '미달성', 500);
...
INSERT INTO MY_RESULT (MR_ID, H_ID, M_ID, MR_DATE, MR_RESULT, MR_POINT) values (MY_RESULT_SEQ.NEXTVAL, 1, 'hansung', '2020-09-18', '미달성', 500);
...
INSERT INTO MY_RESULT (MR_ID, H_ID, M_ID, MR_DATE, MR_RESULT, MR_POINT) values (MY_RESULT_SEQ.NEXTVAL, 1, 'hansung', '2020-09-20', '미달성', 500);
...
INSERT INTO MY_RESULT (MR_ID, H_ID, M_ID, MR_DATE, MR_RESULT, MR_POINT) values (MY_RESULT_SEQ.NEXTVAL, 1, 'hansung', '2020-09-22', '미달성', 500);
INSERT INTO MY_RESULT (MR_ID, H_ID, M_ID, MR_DATE, MR_RESULT, MR_POINT) values (MY_RESULT_SEQ.NEXTVAL, 1, 'hansung', '2020-09-23', '미달성', 500);
...
INSERT INTO MY_RESULT (MR_ID, H_ID, M_ID, MR_DATE, MR_RESULT, MR_POINT) values (MY_RESULT_SEQ.NEXTVAL, 1, 'hansung', '2020-09-25', '미달성', 500);
INSERT INTO MY_RESULT (MR_ID, H_ID, M_ID, MR_DATE, MR_RESULT, MR_POINT) values (MY_RESULT_SEQ.NEXTVAL, 1, 'hansung', '2020-09-26', '미달성', 500);
...
INSERT INTO MY_RESULT (MR_ID, H_ID, M_ID, MR_DATE, MR_RESULT, MR_POINT) values (MY_RESULT_SEQ.NEXTVAL, 2, 'hansung', '2020-08-14', '미달성', 500);
...
INSERT INTO MY_RESULT (MR_ID, H_ID, M_ID, MR_DATE, MR_RESULT, MR_POINT) values (MY_RESULT_SEQ.NEXTVAL, 2, 'hansung', '2020-08-17', '미달성', 500);
...
INSERT INTO MY_RESULT (MR_ID, H_ID, M_ID, MR_DATE, MR_RESULT, MR_POINT) values (MY_RESULT_SEQ.NEXTVAL, 2, 'hansung', '2020-08-24', '미달성', 500);
...
INSERT INTO MY_RESULT (MR_ID, H_ID, M_ID, MR_DATE, MR_RESULT, MR_POINT) values (MY_RESULT_SEQ.NEXTVAL, 2, 'hansung', '2020-08-26', '미달성', 500);
