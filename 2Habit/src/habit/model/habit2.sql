...
/** myhabit 테이블 생성**/
  ...
  CREATE TABLE "MY_HABIT" 
   ...
   "H_DAY" VARCHAR2(100 BYTE), 
   "H_STARTDATE" DATE DEFAULT SYSDATE, 
   "H_ENDDATE" DATE DEFAULT SYSDATE, 
   "H_ALARM" DATE DEFAULT SYSDATE
   );
...
/** challenge 테이블 생성**/
  ...
  CREATE TABLE "CHALLENGE" 
   (   "CH_ID" NUMBER, 
   "M_ID" VARCHAR2(30 BYTE),
   "CH_NAME" VARCHAR2(1000 BYTE), 
   "NUM" NUMBER, 
   "CH_DAY" VARCHAR2(100 BYTE), 
   "CH_STARTDATE" DATE DEFAULT SYSDATE, 
   "CH_ENDDATE" DATE DEFAULT SYSDATE, 
   "CH_CONTENT" VARCHAR2(1500 BYTE), 
   "ALARM" DATE DEFAULT SYSDATE, 
   "CH_FILE" VARCHAR2(500 BYTE)
   ) ;
  ...
  ALTER TABLE "CHALLENGE" MODIFY ("CH_STARTDATE" NOT NULL ENABLE);
...
/** review 테이블 생성**/
  ...
  ALTER TABLE "REVIEW" MODIFY ("R_TITLE" NOT NULL ENABLE);
  ALTER TABLE "REVIEW" MODIFY ("R_CONTENT" NOT NULL ENABLE);
  ...
  ALTER TABLE "MY_RESULT" ADD CONSTRAINT "MY_RESULT_PK" PRIMARY KEY ("H_ID") ENABLE;
